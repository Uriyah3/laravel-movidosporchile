<div class="form-row">
	<div class="col">
		<div class="form-group{{ $errors->has('region_id') ? ' has-error' : '' }}">
			...
			<select class="form-control" name="region_id" id="region_id" value="{{ old('region_id') }}" required>
	...
	<div class="col">
		<div class="form-group{{ $errors->has('provincia_id') ? ' has-error' : '' }}">
			...
			<select class="form-control" name="provincia_id" id="provincia_id" value="{{ old('provincia_id') }}" required>
	...
	<div class="col">
		<div class="form-group{{ $errors->has('comuna_id') ? ' has-error' : '' }}">
			...
			<select class="form-control" name="comuna_id" id="comuna_id" value="{{ old('comuna_id') }}" required>
...
<script>
	$(function () {
		var region_id = {{ old('region_id', 1) }};
		var provincia_id = {{ old('provincia_id', 1) }};
		var comuna_id = {{ old('comuna_id', 1) }};
