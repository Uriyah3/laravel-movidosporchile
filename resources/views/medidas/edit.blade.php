<div class="form-group{{ $errors->has('objetivos') ? ' has-error' : '' }}">
	...
	<textarea class="form-control" id="objetivos" name="objetivos" rows="2" required>{{ old('objetivos', $voluntariado->medida->objetivos) }}</textarea>
...
<div class="form-group{{ $errors->has('descripcion') ? ' has-error' : '' }}">
	...
	<textarea class="form-control" id="descripcion" name="descripcion" rows="3">{{ old('descripcion', $voluntariado->medida->descripcion) }}</textarea>
