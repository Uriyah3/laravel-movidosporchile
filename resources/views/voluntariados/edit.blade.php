	...
	<div class="form-row">
		<div class="col">
			<div class="form-group{{ $errors->has('actividad_voluntariado_id') ? ' has-error' : '' }}">
				...
				<select class="form-control" name="actividad_voluntariado_id" value="{{ old('actividad_voluntariado_id', $voluntariado->actividad_voluntariado_id) }}" required>
		...
		<div class="col">
			<div class="form-group{{ $errors->has('cantidad_voluntarios') ? ' has-error' : '' }}">
				...
				<input type="number" class="form-control" id="cantidad_voluntarios" name="cantidad_voluntarios" value="{{ old('cantidad_voluntarios', $voluntariado->cantidad_voluntarios) }}" required>
	...
	<div class="form-row">
		<div class="col">
			<div class="form-group{{ $errors->has('fecha_inicio') ? ' has-error' : '' }}">
				...
				<input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio" value="{{ old('fecha_inicio', $voluntariado->fecha_inicio) }}" required>
		...
		<div class="col">
			<div class="form-group{{ $errors->has('fecha_termino') ? ' has-error' : '' }}">
				...
				<input type="date" class="form-control" id="fecha_termino" name="fecha_termino" value="{{ old('fecha_termino', $voluntariado->fecha_termino) }}" required>
